...
export default function ProfilPage() {
  ...
  return (
    <DashboardLayout navItems={NAV_PORTEUR} title="Mon Profil" subtitle="Gérez vos informations personnelles">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 300px', gap: 24 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div className="kpi-card" style={{ padding: 24, textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 11, color: 'var(--gold)', textTransform: 'uppercase', letterSpacing: '0.1em', marginTop: 4 }}>Porteur de projet</div>
          ...
          <div className="kpi-card" style={{ padding: 24 }}>
            <SectionLabel>Infos compte</SectionLabel>
            {[
